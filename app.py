...
with main_tabs[1]:
    ...
    # =========================================================
    subheading("A. Data Akreditasi Program Studi")
    ...
    # C. DATA PMB
    # =========================================================
    subheading("C. Data Penerimaan Mahasiswa Baru (PMB)")
    ...
    # =========================================================
    # E. DATA KEBUTUHAN KHUSUS
    # =========================================================
    subheading("E. Data Mahasiswa Berkebutuhan Khusus")
    ...
    # =========================================================
    # F. DATA DAERAH TERTINGGAL
    # =========================================================
    subheading("F. Data Mahasiswa Daerah Tertinggal")
